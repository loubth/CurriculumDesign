...
<head>
    ...
    <script language="javascript" type="text/javascript">
        function removeStudentInfo(studentId) {
            var stuInfoPanel = document.getElementById("stuInfoPanel");
            var student = document.getElementById(studentId);
            stuInfoPanel.removeChild(student);
            alert("删除成功！");
        }
    </script>
        ...
        <table id="stuInfoPanel" class="table table-info  table-bordered">
            <c:forEach items="${studentList}" var="student">
                ...
                <c:if test="${isStudent!=true}">
                    ...
                    <tr>
                        <td>删除</td>
                        <td><a href="/DeleteStudentServlet?id=${student.id}" target="_blank"
                               onclick=removeStudentInfo("${student.id}")>删除</a></td>
                    </tr>
                </c:if>
                    <%--分隔符--%>
                <tr>
                ...
                <tr id="${teacher.id}">
                    ...
                    <c:if test="${isStudent!=true}">
                        ...
                        <td>
                            ...
                            <a href="/DeleteTeacherServlet?id=${teacher.id}" target="_blank"
                               onclick=removeTeacherInfo("${teacher.id}")>删除</a>
                        </td>
                    </c:if>
                </tr>
            </c:forEach>
            ...
            <c:forEach items="${studentGradeList}" var="studentGrade">
                <tr id="${studentGrade.id}">
                    ...
                    <c:if test="${isStudent!=true}">
                        ...
                        <td>
                            <a href="/DeleteStudentGradeServlet?id=${studentGrade.id}" target="_blank"
                               onclick=removeStudentGradeInfo("${studentGrade.id}")>删除</a>
                        </td>
                    </c:if>
                </tr>
            </c:forEach>
                ...
                <tr id="${teacherManage.id}">
                    ...
                    <c:if test="${isStudent!=true}">
                        ...
                        <td>
                            ...
                            <a href="/DeleteTeacherManageServlet?id=${teacherManage.id}" target="_blank"
                               onclick=removeTeacherManageInfo("${teacherManage.id}")>删除</a>
                        </td>
                    </c:if>
                </tr>
